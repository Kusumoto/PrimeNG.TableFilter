...
namespace PrimeNG.TableFilter.Core
{
	...
	public class TableFilterManager<TEntity> : ITableFilterManager<TEntity>
	{
		...
		public void FilterDataSet(string key, TableFilterContext value, OperatorEnumeration @operator = OperatorEnumeration.None)
			=> BaseFilterDataSet(key, value, @operator);
